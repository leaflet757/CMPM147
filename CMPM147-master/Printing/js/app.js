...
define(["processing", "./drawing", "./threeUtils/threeScene", "common", "./particles/particle"], function(_processing, drawing, ThreeScene, common, Particle) {
    'use strict';
    ...
    $.extend(app, {
        ...
        initUI : function() {
            ...
            $("#threeview").mousemove(function(ev) {
            ...
            $('#threeview').mousewheel(function(event) {
            ...
            $("#threeview").draggable({
                ...
                drag : function(event, ui) {
                    ...
                    app.threeScene.phiCenter = y * .007;
                    app.threeScene.thetaCenter = -x * .004;
