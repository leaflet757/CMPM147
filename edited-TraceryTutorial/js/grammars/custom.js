...
define([], function() {'use strict';
	...
	return {
		origin: ["[hero:#character# known for their #qualities#]#hero# went on a #adverb# #action# because #modifier#"],
		
		// story elements
		character: ["Hillary", "Thomas Jefferson", "Cpt. McMillan", ],
		setting: ["in the future", "in the past", "the Roman Empire", "in #location#"], 
		plot: ["lost", "murder mystery", "ran out of nacho cheese", "car was stolen", "stuck under the mistletoe"],
		
		// sentence elements
		action: ["journey", "quest", "hunt", "killing spree", "#adverb# act of kindness"],
		predicate: [],
		clause: [],
		phrase: [],
		modifier: ["reasons"],
		adverb: ["perilous", "quick", "fascinating", "troubling", "quaint", "long", "hard", "random"],
		location: ["isengard", "washington", "the moon", "america"],
		
		// other elements
		qualities: ["dashing good looks", "extreme #animal# #verb#", "archery"],
		animal: ["bear", "sheep", "lizard", "kangaroo", "whale", "mouse"],
		verb: ["watching", "fighting", "wrestling", "conversing", "interpreting"], 
	};
});
