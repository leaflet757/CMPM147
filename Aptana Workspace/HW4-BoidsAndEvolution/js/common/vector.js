...
define(["inheritance"], function(Inheritance) {
    ...
    Vector = Class.extend({
        ...
        drawArrow : function(g, v, m, offset) {
            var nx = 0;
            var ny = 0;
            ...
            g.line(this.x, this.y, v.x * m + this.x + nx, v.y * m + this.y + ny);
        },
        ...
        toCenteredCSS : function(w, h) {
            return {
                width : w + "px",
                height : h + "px",
                top : (this.y - h / 2) + "px",
                left : (this.x - w / 2) + "px",
                //  transform : "translate(" + (this.x - w / 2) + "px," + (this.y - h / 2) + "px)"
            };
        },
    ...
    Vector.polarOffset = function(v, r, theta) {
        return new Vector(v.x + r * Math.cos(theta), v.y + r * Math.sin(theta));
    };
