define(["inheritance", "common"], function(_inheritance, common) {
	...
	var Particle = Class.extend({
		...
		update : function(time) {
			...
			var noiseSample = new Vector(this.position);
			noiseSample.mult(.003);
			var r = 200;
			var theta = 12 * utilities.noise(noiseSample.x, noiseSample.y, app.time.total * .1);
	...
	var VoronoiParticle = Particle.extend({
...
// 			
	...
	Particle.VoronoiParticle = VoronoiParticle;
	return Particle;
});
