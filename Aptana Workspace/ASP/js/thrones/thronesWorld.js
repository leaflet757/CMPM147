...
define(["common", "../world/world", "./place", "./character", "./data", "../asp/solver"], function(common, world, Place, Character, data, solver) {
    ...
    function start() {
        ...
        function makeFactsAndSolve() {
			...
			rules += "knowsDarkMagic(A, true) :- gender(A, female), isParent(A, _).\n";
			rules += "isDragon(A, true) :- knowsDarkMagic(A, true).\n"
			rules += "canOwnDragon(A, true) :- isParent(A, B), gender(B, male).\n";
			...
			// DRAGONS
			rules += "1 { ownsDragons(A, B) :canOwnDragon(A, true) } 3 :- isDragon(B, true)."
